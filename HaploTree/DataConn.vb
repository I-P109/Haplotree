...
Module DataConn
    ...
    '***************************************************************************************************
    Public Function GetConnectionVariantHg19DB() As OleDb.OleDbConnection
        Dim strConnectionString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & App_Path() & "VariantHg19DB.accdb;Persist Security Info=False"
    ...
    '***************************************************************************************************
    Public Function GetConnectionHaploTreeDB() As OleDb.OleDbConnection
        Dim strConnectionString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & App_Path() & "HaploTreeDB.accdb;Persist Security Info=False"
